# -*- coding: utf-8 -*-
"""COMP 2211 Assignment 2 Spam Email Classification (2).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1hRYsMZwvmt15vS4Y6K2bXTZvcWXcMf8v
    ...
    for element in cleaned_emails:
      ...
      for ele in temp:
        if ele not in vocab:
          ...
          new_row.append(word_to_index[ele])
      encoded_emails.append(new_row)
...
def pad_encoded_emails(encoded_emails, max_len = 300):
    ...
    for index, word in enumerate(encoded_emails):
      word = word[:max_len]
      padded_emails[index, :len(word)] = word
